...
echo $indigo"=============================================================="
echo
echo $white "╭─"$yellow"T0B1"$cyan" ~/LCI"$white
read -p " ╰─$ "  apaan
echo
...
echo $green "╭─"$blue"T0B1"$cyan" ~/LCI"$white
read -p " ╰─$ "  target
echo
 			        
echo $red "Masukan Script nya cok!!! "
echo $green "╭─"$blue"T0B1"$cyan" ~/Nama SC Harus (index.html) ganti dulu sana"$white
read -p " ╰─$ "  script
...
echo
echo "Masukan Script !!!!"
echo $white "╭─"$green"T0B1"$cyan" ~/LCI"$white                               
read -p " ╰─$ " script
echo
echo 			      			        
...
echo $white "╭─"$green"T0B1"$cyan" ~/Crot"$white
read -p " ╰─$ " target3
